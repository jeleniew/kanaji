...
class ModelService {
  ...
  Future<void> init() async {
    try {
      ...
      model5 = ModelRunner('assets/models/cnn_etl9g_5s_20e_nomargin_smooth.tflite');
      model6 = ModelRunner('assets/models/cnn_etl9g_5s_20e_nomargin_smooth_2v.tflite');
      model7 = ModelRunner('assets/models/cnn_etl9g_5s_20e_nomargin_smooth_simple.tflite');
      model8 = ModelRunner('assets/models/cnn_etl9g_5s_50e_nomargin_smooth_simple.tflite');
